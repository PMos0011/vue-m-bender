<template>
  <div class="offert-content">
    ...
    <div class="offert-description">
      <app-offert-description isCenter="false" v-if="showLeft">
      ...
      <app-offert-description isCenter="true" v-if="showCenter">
      ...
      <app-offert-description isCenter="false" v-if="showRight">
